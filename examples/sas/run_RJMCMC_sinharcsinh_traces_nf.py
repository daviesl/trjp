...
if len(sys.argv) < 2 or sys.argv[1]=="run":
    ...
    # save it
    np.save('{}rqma_sas_rjmcmc_theta_run{}.npy'.format(pfx,run_no),final_theta)
    np.save('{}rqma_sas_rjmcmc_ptheta_run{}.npy'.format(pfx,run_no),prop_theta)
    np.save('{}rqma_sas_rjmcmc_ar_run{}.npy'.format(pfx,run_no),prop_theta)
